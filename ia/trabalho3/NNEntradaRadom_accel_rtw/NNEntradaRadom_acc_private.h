 ...
 */
#ifndef _RTW_HEADER_NNEntradaRadom_acc_private_h_
#define _RTW_HEADER_NNEntradaRadom_acc_private_h_
#include "rtwtypes.h"
...
#endif                                 /* _RTW_HEADER_NNEntradaRadom_acc_private_h_ */
