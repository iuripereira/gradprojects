...
public class SilvioBSTreeTest2<T> {
  
	public SilvioBSTreeTest2(){}
        ...
        public static void main(String[] args){
          BSTree<String> bt;
          SilvioBSTreeTest2<String> teste = new SilvioBSTreeTest2<String>();
          int adicionados=0;
          ...
          String[] data = {"Carla", "Fabiana", "Ana", "Emanuele", "Daniele", "Bruna"};
